...
Route::group([
    ...
    Route::crud('labor', 'LaborCrudController');
    Route::crud('gashazard', 'GashazardCrudController');
    Route::crud('earthen', 'EarthenCrudController');
    Route::crud('capacity', 'CapacityCrudController');
